...
/**
 * `POST /api/devices/heartbeat`. The route belongs to WP5 (it is a sync
 * mechanism); the body and the service that answers it are WP1's, because both
 * describe a *device* (§12's four-times-claimed-subtree table).
 */
