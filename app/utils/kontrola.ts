...
export const KONTROLA: KontrolaSection[] = [
  ...
  },
  {
    ...
    title: 'Zaliha',
    links: [
      { id: 'artikli', to: '/admin/kontrola/artikli', label: 'Artikli zalihe', sub: 'Jedinica, paket, nabavna cijena, tolerancija', ready: true },
  ...
  },
  {
    ...
    links: [
      ...
      { id: 'sabloni', to: '/admin/kontrola/sabloni', label: 'Šabloni smjena', sub: 'Vrijeme prve i druge smjene', ready: true },
