 ...
 * in `/k`: the server declares `GET /api/owner/log` as `admin` and `requireRole`
 * enforces it a second time. It is the same rule that keeps the *Konobari*
 * channel out of the owner's app, pointed the other way.
 *
