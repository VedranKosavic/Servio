...
/**
 * `/a/razgovor` — *Razgovor*, from the owner's desk.
 *
 ...
 * as S15/S16 and none of its CSS: `/a` is light, `/k` is dark, and the two never
 * share a rule.
 *
 ...
 * only, because a screenshot of `/a` lives in a gallery and a camera photo of a
